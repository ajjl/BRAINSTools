...
# Configure testing.
# HACK for testing ctest we will timeout quickly
...
#HACK always write new cache. we may have updated cache values and dont know how to check yes
...
message("restart reconfigure, clean brainstools. rebuild brainstools test testcoverage")
ctest_start(${dashboard_model})
...
message("done with ctest_test()")
message("ctest_coverage()")
ctest_coverage()
message("done with ctest_coverage()")
message("ctest_submit()")
ctest_submit()
message("done with ctest_submit()")
message(FATAL_ERROR "the end")

ctest_build(${CTEST_BUILD_LOCATION_ARGS} TARGET clean)
message("reconfiguring for BRAINSTools")
ctest_configure(${CTEST_BUILD_LOCATION_ARGS})
message("done with ctest_configure for BRAINSTools")
message("starting ctest_build for BRAINSTools")
ctest_build(${CTEST_BUILD_LOCATION_ARGS})
...
message("starting ctest_test")
    ...
    ctest_test(${CTEST_BUILD_LOCATION_ARGS} START 1 END 1)
    message("After ctest_test")


    if(dashboard_do_coverage)
message("about to perform coverage")
      ctest_coverage( ${CTEST_BUILD_LOCATION_ARGS} )
      #ctest_coverage()
message("after ctest_coverage")
message("preparing to submit")
      ctest_submit()
message("after ctest_submit")
message(FATAL_ERROR the end)
      ctest_coverage( ${CTEST_BUILD_LOCATION_ARGS} )
      ctest_submit()
      
message("Build location:${CTEST_BUILD_LOCATION_ARGS}")
message(FATAL_ERROR "Test:${CTEST_TEST_ARGS}")
